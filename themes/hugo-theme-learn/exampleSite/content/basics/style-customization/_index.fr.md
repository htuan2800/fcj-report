...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/fcj-report/images/` et nommez le `favicon.png`
...
```html
<link rel="shortcut icon" href="/fcj-report/images/favicon.png" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/fcj-report/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/fcj-report/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/fcj-report/images/green-variant.png?width=60pc)
