...
* Phác thảo sơ đồ luồng "Xử lý tài liệu" và "Hỏi đáp" ở mức ý tưởng.
...
| 7 | - Phác thảo sơ đồ ý tưởng cho 2 giai đoạn được phân công: **Xử lý tài liệu** — Lambda nhận văn bản đã OCR, gọi Bedrock tạo vector, lưu vào RDS; **Hỏi đáp** — Lambda nhận câu hỏi, tạo vector câu hỏi, tìm kiếm ngữ nghĩa trong RDS, ghép ngữ cảnh vào prompt gửi LLM <br> - Hoàn thiện, cập nhật Worklog tuần 1 và tuần 2 | 04/07/2026 | 04/07/2026 | Personal GitHub Repository |
...
* Phác thảo sơ đồ ý tưởng cho Xử lý tài liệu và Hỏi đáp — nền tảng để code trong các tuần tới.