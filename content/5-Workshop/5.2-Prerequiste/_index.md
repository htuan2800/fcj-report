...
![AWS Region](/fcj-report/images/2-Proposal/region.png)
...
![Lambda IAM Role](/fcj-report/images/2-Proposal/policy.png)
...
![Create VPC](/fcj-report/images/2-Proposal/vpc1.png)
...
![Create VPC](/fcj-report/images/2-Proposal/vpc2.png)
![Create VPC](/fcj-report/images/2-Proposal/vpc3.png)
7. VPC endpoints -> S3 Gateway; select **Enable DNS hostnames** and **Enable DNS resolution**.
![Create VPC](/fcj-report/images/2-Proposal/vpc4.png)
8. Review the configuration and select **Create VPC**. 9. Select **View VPC**.
![Create VPC](/fcj-report/images/2-Proposal/vpcflow.png)
10. Display the newly created VPC.
![Create VPC](/fcj-report/images/2-Proposal/vpc.png)
...
![DB subnet group](/fcj-report/images/2-Proposal/subnetg1.png)
3. Select the VPC `document-chatbot-vpc-dev` created in the previous step.
![DB subnet group](/fcj-report/images/2-Proposal/sng3.png)
4. Select subnets spanning at least two Availability Zones.
![DB subnet group](/fcj-report/images/2-Proposal/subnetg2.png)
5. Create the DB Subnet Group and use it when creating the RDS PostgreSQL instance.
![DB subnet group](/fcj-report/images/2-Proposal/subnetg4.png)
...
![Lambda security group](/fcj-report/images/2-Proposal/lambdasg.png)
![Lambda security group](/fcj-report/images/2-Proposal/lambdasg2.png)
...
![RDS inbound rule](/fcj-report/images/2-Proposal/rdssg1.png)
![RDS inbound rule](/fcj-report/images/2-Proposal/rdssg2.png)

### Step 4: Attach Lambda to VPC

1. Open the Lambda function that needs to connect to RDS. ![Lambda VPC configuration](/fcj-report/images/2-Proposal/vpclambda1.png)
![Lambda VPC configuration](/fcj-report/images/2-Proposal/vpclambda2.png)
...
![Lambda VPC configuration](/fcj-report/images/2-Proposal/vpclambda3.png)
...
![Secret k](/fcj-report/images/2-Proposal/sec1.png)
3. Open the **Master credentials** link to the secret managed by RDS.
![Secret k](/fcj-report/images/2-Proposal/sec2.png)
